...
class BookingRepositoryTest {
    ...
    Booking booking = new Booking(1L, LocalDateTime.now().withNano(0), LocalDateTime.now().withNano(0).plusDays(1),
            item, userInputElena, Status.WAITING, null);
    Booking pastBooking = new Booking(2L, LocalDateTime.now().minusDays(1), LocalDateTime.now().minusDays(2),
            item, userInputElena, Status.WAITING, null);
    Booking futureBooking = new Booking(3L, LocalDateTime.now().plusDays(1), LocalDateTime.now().plusDays(2),
            item, userInputElena, Status.WAITING, null);
